...
int main(int argc, char** argv)
{
    ...
    glm::mat4 viewMatrix = snake.getViewMatrix();
    ...
    while(viscg::ProcessAllMesages()) { 
        ...
        double elapsedTimeSinceLastFrame = viscg::ElapsedTime() - lastTime;
        lastTime = viscg::ElapsedTime();

        snake.draw(viewMatrix, projectionMatrix, elapsedTimeSinceLastFrame);
